...
<head>
    ...
    <title>Remove Personal Details</title>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
    <a class="navbar-brand" href="#">Remove Details</a>
...
<!-- Content Section -->
<div class="container">
    <h1>Remove Personal Details</h1>
    <form name="detailsForm" action="remove_details_outcome.jsp">
