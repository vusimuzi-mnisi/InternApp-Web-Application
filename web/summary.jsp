...
<div class="container">
        ...
        <table class="table">
            ...
            %>
                <tr>
                    ...
                    <td><%= rs.getDate("closing_date") %></td>
                </tr>
            <% 
                    }
                    rs.close();
                    
                    String countSql = "SELECT COUNT(*) AS total FROM internships_tbl";
    ...
    <div class="total">
        <h2>Total Internships : <%= internshipCount %></h2>
    </div>
    <div class="pdf-link">
        <a href="files\internshipsFile.txt" class="btn btn-secondary">Report File</a>
    </div>
</div>
