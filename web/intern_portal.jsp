...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <a class="navbar-brand" href="intern_portal.jsp">Intern Portal</a>
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
                <a class="nav-link" href="internships.jsp">View Vacancies</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="applications.jsp">Track Applications</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="intern_menu.jsp">Manage Details</a>
            </li>           
            <li class="nav-item">
...
<div class="container-fluid content">
        <div class="row">
            <div class="col-md-6 background-image">
                <img src="images\webp2.webp" alt="alt"/>
            </div>
